...
To validate classification accuracy, we conducted human spot-checking of 200 randomly sampled comments. For advice direction---our primary outcome measure---the LLM classifier achieved \textbf{96\% agreement} with human judgment.
